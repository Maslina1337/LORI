...
const public_server_values: {[key: string]: any , genres: Array<string>} = {
    ...
    genres: JSON.parse(String(fs.readFileSync(path.join(__dirname, "../data_management/genres.json")))),
};

export { public_server_values };